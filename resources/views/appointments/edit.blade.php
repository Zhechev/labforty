        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">Редактиране на час</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('appointments.update', $appointment->id) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control datetime-picker @error('appointment_datetime') is-invalid @enderror"
                                    ...
                                    value="{{ old('appointment_datetime', $appointment->appointment_datetime->format('Y-m-d H:i')) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('client_name') is-invalid @enderror"
                                    id="client_name" name="client_name" value="{{ old('client_name', $appointment->client_name) }}"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('egn') is-invalid @enderror"
                                    id="egn" name="egn" value="{{ old('egn', $appointment->egn) }}"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6" id="email-field" style="{{ (old('notification_method', $appointment->notification_method) == 'sms') ? 'display: none;' : '' }}">
                            ...
                            <div class="col-md-6" id="phone-field" style="{{ (old('notification_method', $appointment->notification_method) != 'sms') ? 'display: none;' : '' }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror"
                                ...
                                placeholder="Въведете описание (по желание)">{{ old('description', $appointment->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
